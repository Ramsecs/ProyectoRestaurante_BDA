...
//Capas de negocio (BOs)
    ...
    */
    ...
    /**
     * Mediante este metodo cambiamos de la ventana menu productos a ventana de menu administrador.
     */
    ...
    /**
     * Mediante este metodo se manda la lista de ingredientes y el producto a registrar en BO.
    ...
    /**
     * Este metodo muestra la ventana de los ingredeintes de un producto cuando se da click en el boton
     * ver detalles en la tabla del menu de productos
     * @param ventana
     * @param datosProducto 
     */
    ...
    /**
     * Este metodo devuelve el valor boolean de la validacion que se hace a el texto de nombre. 
     * @param nombre
     * @return 
     */
    ...
    /**
     * Este metodo devuelve el valor boolean de la validacion que se hace a el texto de cant(Cantidad).
     * @param cant
     * @return 
     */
    ...
    /**
     * Este metodo devuelve el valor boolean de la validacion que se hace a el texto de precio.
     * @param precio
     * @return 
     */
    ...
    /**
     * Mediante este metodo se actualiza el nombre del producto cuando se cambia el nombre
     * del producto en la tabla de productos
     * @param id
     * @param nuevoNombre 
     */
    ...
    /**
     * Mediante este metodo se actualiza el precio del producto cuando se cambia el precio
     * del producto en la tabla de productos
     * @param id
     * @param nuevoPrecio 
     */
